...
class MyTestCase(unittest.TestCase):
    def test_output_instances(self):
        ...
        self.assertEqual("['ANG', 'NAM']", distros_df.at['76360-1', 'iso3_codes'], msg=f'76360-1')
        self.assertEqual("['SAM']", distros_df.at['77164465-1', 'iso3_codes'], msg=f'77164465-1')
        self.assertEqual("['CHC', 'CHT']", distros_df.at['756598-1', 'iso3_codes'], msg=f'756598-1')
